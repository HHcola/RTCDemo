...
#define AGORA_SDK_VERSION "1.0.0.42"
...
#ifndef NOIOSMEDIA
+ (AgoraAPI*) getInstanceWithMedia:(NSString*)vendorKey media:(AgoraRtcEngineKit*) media;
+ (AgoraAPI*) getInstanceWithMediaKey:(NSString*)vendorKey;
- (AgoraRtcEngineKit*) getMedia;
#endif
