...
public class GridVideoViewContainerAdapter extends VideoViewAdapter {
    ...
    public GridVideoViewContainerAdapter(Context context, int localUid, HashMap<Integer, VideoViewDecorator> uids, VideoViewEventListener listener) {
    ...
    @Override
    public void notifyUiChanged(HashMap<Integer, VideoViewDecorator> uids, int localUid, HashMap<Integer, Integer> status, HashMap<Integer, Integer> volume) {
