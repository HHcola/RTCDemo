...
import io.agora.ag_faceu.ui.VideoViewDecorator;
...
public class UserStatusData {
    ...
    public UserStatusData(int uid, VideoViewDecorator view, Integer status, int volume) {
        this(uid, view, status, volume, null);
    }

    public UserStatusData(int uid, VideoViewDecorator view, Integer status, int volume, VideoInfoData i) {
        this.mUid = uid;
        this.mView = view;
        this.mStatus = status;
        this.mVolume = volume;
    ...
    public VideoViewDecorator mView;
