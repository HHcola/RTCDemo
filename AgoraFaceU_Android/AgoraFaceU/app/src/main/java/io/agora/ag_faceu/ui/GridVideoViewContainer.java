...
public class GridVideoViewContainer extends RecyclerView {
    ...
    private boolean initAdapter(int localUid, HashMap<Integer, VideoViewDecorator> uids) {
    ...
    public void initViewContainer(Context context, int localUid, HashMap<Integer, VideoViewDecorator> uids) {
